		...
		<div class="container">
          ...
          <div class="col-md-8 col-sm-8 col-xs-12">
            <div class="list_botton">
              <div class = "btnPost_p">                              
                <h3><c:if test="${role=='tout' }">과제제출실</c:if></h3>
            ...
            <table class = "table table-hover mt-3">
                ...
                <c:forEach items="${list}" var="board" >
                	<tr>
                		<td>${i=i-1 }</td>
                		<td class = 'list_title'><a href="/class/detail?course=${course }&&role=${role }&&bno=${board.bno}" >${board.title }</a> 
                		<span style="font-size: medium;"> <i class="bi bi-chat" ></i> <a style = "font-size: medium;" href="#">${board.fileCount }</a> </span></td>
                		<td>${board.writer }</td>
