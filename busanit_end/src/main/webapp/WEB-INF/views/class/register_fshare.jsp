		...
		<div class="row">
			...
			<div class="col-md-8 col-sm-8 col-xs-12">
				<article class="blog-post-wrapper">
					...
					<form action="/class/register" method="post" role="form" class="insert-form" enctype="multipart/form-data">
						<input class = "form-control" type = "file" name = "uploads" id = "uploads" multiple />
...
<!-- 							<label for="floatingTextarea">글 내용</label> -->
						...
						<div class="text-center">
							<button class = "list_btn" type="submit">전송</button>
						</div>
					</form>
				</article>
				<div class="clear"></div>
